...
namespace TabCon {
	...
	public class MySQL_Util {
		...
		public MySQL_Util()
			...
			public ObservableCollection<object> ReadTable(string tableName)
			{
				string TAG = "ReadTable";
				string dbMsg = "[MySQLBase]";
				try {
				ObservableCollection<object> wCollection = new ObservableCollection<object>();
				...
				DateTime dt = DateTime.Now;
					...
					Type myType = typeof(Views.MySQLBase);
