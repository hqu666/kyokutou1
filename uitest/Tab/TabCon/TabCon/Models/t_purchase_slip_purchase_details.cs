...
namespace TabCon.Models
{
	...
	/// 購買情報伝票（仕入書明細）
	/// </summary>
	public partial class t_purchase_slip_purchase_details : NotificationObject
	{
		...
		///<summary>
		///購買仕入ヘッダID :=購買情報伝票（仕入ヘッダ）.ID
		///</summary>
		private int _t_purchase_slip_purchase_headers_id;
		public int t_purchase_slip_purchase_headers_id
		{
			get => _t_purchase_slip_purchase_headers_id;
			set
			{
				if (_t_purchase_slip_purchase_headers_id == value)
					return;
				_t_purchase_slip_purchase_headers_id = value;
				RaisePropertyChanged();
			}
		}
	...
	public class t_purchase_slip_purchase_detailsCollection : ObservableCollection<t_purchase_slip_purchase_details> {
		public t_purchase_slip_purchase_detailsCollection(){
		}
	}
}
