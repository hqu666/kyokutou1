...
namespace TabCon.Models
{
	...
	/// 購買情報伝票（テンプレート明細）
	/// </summary>
	public partial class t_purchase_slip_template_details : NotificationObject
	{
	...
	public class t_purchase_slip_template_detailsCollection : ObservableCollection<t_purchase_slip_template_details> {
		public t_purchase_slip_template_detailsCollection(){
		}
	}
}
