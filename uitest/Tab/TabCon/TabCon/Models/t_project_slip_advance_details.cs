...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（前受金請求書明細）
	/// </summary>
	public partial class t_project_slip_advance_details : NotificationObject
	{
		...
		///<summary>
		///前受金請求書ヘッダID :=案件情報伝票（前受金請求書ヘッダ）．ID
		///</summary>
		private int _t_project_slip_advance_headers_id;
		public int t_project_slip_advance_headers_id
		{
			get => _t_project_slip_advance_headers_id;
			set
			{
				if (_t_project_slip_advance_headers_id == value)
					return;
				_t_project_slip_advance_headers_id = value;
				RaisePropertyChanged();
			}
		}
	...
	public class t_project_slip_advance_detailsCollection : ObservableCollection<t_project_slip_advance_details> {
		public t_project_slip_advance_detailsCollection(){
		}
	}
}
