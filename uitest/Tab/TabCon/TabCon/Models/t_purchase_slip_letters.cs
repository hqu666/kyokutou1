...
namespace TabCon.Models
{
	...
	/// 購買情報伝票（送付状）
	/// </summary>
	public partial class t_purchase_slip_letters : NotificationObject
	{
	...
	public class t_purchase_slip_lettersCollection : ObservableCollection<t_purchase_slip_letters> {
		public t_purchase_slip_lettersCollection(){
		}
	}
}
