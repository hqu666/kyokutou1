...
namespace TabCon.Models
{
	...
	/// ©Ğ—\Zƒ}ƒXƒ^
	/// </summary>
	public partial class BudgetOwnCompanies
	{
	...
	public class BudgetOwnCompaniesCollection : ObservableCollection<BudgetOwnCompanies> {
		public BudgetOwnCompaniesCollection(){
		}
	}
}
