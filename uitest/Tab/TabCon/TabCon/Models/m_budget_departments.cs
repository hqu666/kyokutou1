...
namespace TabCon.Models
{
	...
	/// •”–å•Ê—\Zƒ}ƒXƒ^
	/// </summary>
	public partial class m_budget_departments : NotificationObject
	{
	...
	public class m_budget_departmentsCollection : ObservableCollection<m_budget_departments> {
		public m_budget_departmentsCollection(){
		}
	}
}
