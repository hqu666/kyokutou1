...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（前受金請求書明細）
	/// </summary>
	public partial class ProjectSlipAdvanceDetails
	{
	...
	public class ProjectSlipAdvanceDetailsCollection : ObservableCollection<ProjectSlipAdvanceDetails> {
		public ProjectSlipAdvanceDetailsCollection(){
		}
	}
}
