...
namespace TabCon.Models
{
	...
	/// 購買情報伝票（仕入書明細）
	/// </summary>
	public partial class PurchaseSlipPurchaseDetails
	{
	...
	public class PurchaseSlipPurchaseDetailsCollection : ObservableCollection<PurchaseSlipPurchaseDetails> {
		public PurchaseSlipPurchaseDetailsCollection(){
		}
	}
}
