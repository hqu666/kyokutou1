...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（テンプレート明細）
	/// </summary>
	public partial class ProjectSlipTemplateDetails
	{
	...
	public class ProjectSlipTemplateDetailsCollection : ObservableCollection<ProjectSlipTemplateDetails> {
		public ProjectSlipTemplateDetailsCollection(){
		}
	}
}
