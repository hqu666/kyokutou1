...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（テンプレート明細）
	/// </summary>
	public partial class t_project_slip_template_details : NotificationObject
	{
		...
		///<summary>
		///テンプレートヘッダID :=案件情報伝票（テンプレートヘッダ）.ID
		///</summary>
		private int _template_header_id;
		public int template_header_id
		{
			get => _template_header_id;
			set
			{
				if (_template_header_id == value)
					return;
				_template_header_id = value;
				RaisePropertyChanged();
			}
		}
		...
		///必要係数
		///</summary>
		private float _required_factor_cost;
		public float required_factor_cost
		{
			get => _required_factor_cost;
			set
			{
				if (_required_factor_cost == value)
					return;
				_required_factor_cost = value;
				RaisePropertyChanged();
			}
		}
	...
	public class t_project_slip_template_detailsCollection : ObservableCollection<t_project_slip_template_details> {
		public t_project_slip_template_detailsCollection(){
		}
	}
}
