...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（見積書明細）
	/// </summary>
	public partial class ProjectSlipEstimateDetails
	{
	...
	public class ProjectSlipEstimateDetailsCollection : ObservableCollection<ProjectSlipEstimateDetails> {
		public ProjectSlipEstimateDetailsCollection(){
		}
	}
}
