...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（発注書ヘッダ）
	/// </summary>
	public partial class t_project_slip_order_headers : NotificationObject
	{
	...
	public class t_project_slip_order_headersCollection : ObservableCollection<t_project_slip_order_headers> {
		public t_project_slip_order_headersCollection(){
		}
	}
}
