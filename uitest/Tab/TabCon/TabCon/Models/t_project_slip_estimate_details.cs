...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（見積書明細）
	/// </summary>
	public partial class t_project_slip_estimate_details : NotificationObject
	{
		...
		///<summary>
		///見積書ヘッダID :=案件情報伝票（見積書ヘッダ）．ID
		///</summary>
		private int _t_project_slip_estimate_headers_id;
		public int t_project_slip_estimate_headers_id
		{
			get => _t_project_slip_estimate_headers_id;
			set
			{
				if (_t_project_slip_estimate_headers_id == value)
					return;
				_t_project_slip_estimate_headers_id = value;
				RaisePropertyChanged();
			}
		}
	...
	public class t_project_slip_estimate_detailsCollection : ObservableCollection<t_project_slip_estimate_details> {
		public t_project_slip_estimate_detailsCollection(){
		}
	}
}
