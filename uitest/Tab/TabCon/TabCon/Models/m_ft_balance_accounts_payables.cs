...
namespace TabCon.Models
{
	...
	/// 初回残高買掛額
	/// </summary>
	public partial class m_ft_balance_accounts_payables : NotificationObject
	{
	...
	public class m_ft_balance_accounts_payablesCollection : ObservableCollection<m_ft_balance_accounts_payables> {
		public m_ft_balance_accounts_payablesCollection(){
		}
	}
}
