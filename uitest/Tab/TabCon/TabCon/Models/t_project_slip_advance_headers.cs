...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（前受金請求書ヘッダ）
	/// </summary>
	public partial class t_project_slip_advance_headers : NotificationObject
	{
	...
	public class t_project_slip_advance_headersCollection : ObservableCollection<t_project_slip_advance_headers> {
		public t_project_slip_advance_headersCollection(){
		}
	}
}
