...
namespace TabCon.Models
{
	...
	/// 買掛サマリー情報
	/// </summary>
	public partial class t_accounts_payable_summaries : NotificationObject
	{
	...
	public class t_accounts_payable_summariesCollection : ObservableCollection<t_accounts_payable_summaries> {
		public t_accounts_payable_summariesCollection(){
		}
	}
}
