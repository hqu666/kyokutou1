...
namespace TabCon.Models
{
	...
	/// 取込項目設定
	/// </summary>
	public partial class m_import_item_settings : NotificationObject
	{
	...
	public class m_import_item_settingsCollection : ObservableCollection<m_import_item_settings> {
		public m_import_item_settingsCollection(){
		}
	}
}
