...
{
	/// <summary>
	/// ˆÄŒî•ñ“`•[iŒ©Ï‘ƒwƒbƒ_j
	/// </summary>
	public partial class t_project_slip_estimate_headers : NotificationObject
	{
	...
	public class t_project_slip_estimate_headersCollection : ObservableCollection<t_project_slip_estimate_headers> {
		public t_project_slip_estimate_headersCollection(){
		}
	}
}
