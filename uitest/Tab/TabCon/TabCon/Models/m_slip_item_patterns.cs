...
namespace TabCon.Models
{
	...
	/// 伝票明細パターンマスタ
	/// </summary>
	public partial class m_slip_item_patterns : NotificationObject
	{
	...
	public class m_slip_item_patternsCollection : ObservableCollection<m_slip_item_patterns> {
		public m_slip_item_patternsCollection(){
		}
	}
}
