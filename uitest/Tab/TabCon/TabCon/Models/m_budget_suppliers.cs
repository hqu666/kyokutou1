...
namespace TabCon.Models
{
	...
	/// “¾ˆÓæ•Ê—\Zƒ}ƒXƒ^
	/// </summary>
	public partial class m_budget_suppliers : NotificationObject
	{
	...
	public class m_budget_suppliersCollection : ObservableCollection<m_budget_suppliers> {
		public m_budget_suppliersCollection(){
		}
	}
}
