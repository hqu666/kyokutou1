...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（発注書明細）
	/// </summary>
	public partial class t_project_slip_order_details : NotificationObject
	{
	...
	public class t_project_slip_order_detailsCollection : ObservableCollection<t_project_slip_order_details> {
		public t_project_slip_order_detailsCollection(){
		}
	}
}
