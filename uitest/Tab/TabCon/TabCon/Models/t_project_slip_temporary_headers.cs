...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（仮売上請求書ヘッダ）
	/// </summary>
	public partial class t_project_slip_temporary_headers : NotificationObject
	{
	...
	public class t_project_slip_temporary_headersCollection : ObservableCollection<t_project_slip_temporary_headers> {
		public t_project_slip_temporary_headersCollection(){
		}
	}
}
