...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（請求明細書明細）
	/// </summary>
	public partial class t_project_slip_invoice_details : NotificationObject
	{
		...
		///<summary>
		///請求明細書ヘッダID :=案件情報伝票（請求明細書ヘッダ）.ID
		///</summary>
		private int _t_project_slip_invoice_headers_id;
		public int t_project_slip_invoice_headers_id
		{
			get => _t_project_slip_invoice_headers_id;
			set
			{
				if (_t_project_slip_invoice_headers_id == value)
					return;
				_t_project_slip_invoice_headers_id = value;
				RaisePropertyChanged();
			}
		}
	...
	public class t_project_slip_invoice_detailsCollection : ObservableCollection<t_project_slip_invoice_details> {
		public t_project_slip_invoice_detailsCollection(){
		}
	}
}
