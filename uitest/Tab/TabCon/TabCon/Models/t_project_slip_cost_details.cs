...
namespace TabCon.Models
{
	...
	/// 案件情報伝票（原価明細）
	/// </summary>
	public partial class t_project_slip_cost_details : NotificationObject
	{
	...
	public class t_project_slip_cost_detailsCollection : ObservableCollection<t_project_slip_cost_details> {
		public t_project_slip_cost_detailsCollection(){
		}
	}
}
