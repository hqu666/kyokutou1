namespace kyokuto4calender {
	partial class GoogleDriveBrouser {
		...
		private void InitializeComponent()
		{
			...
			this.pass_tv.Location = new System.Drawing.Point(10, 42);
			this.pass_tv.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.pass_tv.Name = "pass_tv";
			this.pass_tv.Size = new System.Drawing.Size(180, 236);
			...
			this.file_list_Lv.Location = new System.Drawing.Point(194, 42);
			this.file_list_Lv.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.file_list_Lv.Name = "file_list_Lv";
			this.file_list_Lv.Size = new System.Drawing.Size(442, 236);
			...
			this.contextMStrip.Size = new System.Drawing.Size(99, 26);
			// 
			// DelTSMenuItem
			// 
			this.DelTSMenuItem.Name = "DelTSMenuItem";
			this.DelTSMenuItem.Size = new System.Drawing.Size(98, 22);
			this.DelTSMenuItem.Text = "削除";
			this.DelTSMenuItem.Click += new System.EventHandler(this.DelTSMenuItem_Click);
			// 
			// openFDialog
			// 
			this.openFDialog.CheckFileExists = false;
			this.openFDialog.CheckPathExists = false;
			this.openFDialog.FileName = "openFileDialog1";
			this.openFDialog.Multiselect = true;
			this.openFDialog.RestoreDirectory = true;
			this.openFDialog.SupportMultiDottedExtensions = true;
			// 
			// pass_name_lb
			// 
			...
			this.pass_name_lb.Location = new System.Drawing.Point(9, 7);
			this.pass_name_lb.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.pass_name_lb.Name = "pass_name_lb";
			this.pass_name_lb.Size = new System.Drawing.Size(171, 24);
			...
			this.file_open_bt.Location = new System.Drawing.Point(560, 20);
			this.file_open_bt.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.file_open_bt.Name = "file_open_bt";
			this.file_open_bt.Size = new System.Drawing.Size(76, 18);
