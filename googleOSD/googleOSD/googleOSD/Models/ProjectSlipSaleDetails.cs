...
namespace GoogleOSD.Models{
	...
	/// 案件情報伝票（受注請書明細）
	/// </summary>
	public partial class ProjectSlipSaleDetails{
		///ID
		public int id { get; set; }
		///契約ID :=契約マスタ.ID
		public int m_contract_id { get; set; }
		///受注書ヘッダID :=案件情報伝票（見積書ヘッダ）．ID
		public int t_project_slip_sale_headers_id { get; set; }
		///行番号
	...
	public class ProjectSlipSaleDetailsCollection : ObservableCollection<ProjectSlipSaleDetails> {
		public ProjectSlipSaleDetailsCollection(){
		}
	}
}
